...
class SizeBSTTest(unittest.TestCase):
    def setUp(self):
        self.tree1 = SizeBST()

        self.tree1.insert(23)
        self.assertEqual(1, self.tree1.find(23).size)

        self.tree1.insert(8)
        self.assertEqual(2, self.tree1.find(23).size)
        self.assertEqual(1, self.tree1.find(8).size)

        self.tree1.insert(4)
        self.assertEqual(3, self.tree1.find(23).size)
        self.assertEqual(2, self.tree1.find(8).size)
        self.assertEqual(1, self.tree1.find(4).size)

        self.tree1.insert(16)
        self.assertEqual(4, self.tree1.find(23).size)
        self.assertEqual(3, self.tree1.find(8).size)
        self.assertEqual(1, self.tree1.find(4).size)
        self.assertEqual(1, self.tree1.find(16).size)

        self.tree1.insert(15)
        self.assertEqual(5, self.tree1.find(23).size)
        self.assertEqual(4, self.tree1.find(8).size)
        self.assertEqual(1, self.tree1.find(4).size)
        self.assertEqual(2, self.tree1.find(16).size)
        self.assertEqual(1, self.tree1.find(15).size)

        self.tree1.insert(42)
        self.assertEqual(6, self.tree1.find(23).size)
        self.assertEqual(4, self.tree1.find(8).size)
        self.assertEqual(1, self.tree1.find(4).size)
        self.assertEqual(2, self.tree1.find(16).size)
        self.assertEqual(1, self.tree1.find(15).size)
        self.assertEqual(1, self.tree1.find(42).size)
    ...
    def testInsert(self):
        ...
        tree2.insert(5)
        self.assertEqual(5, tree2.find(5).key)
        self.assertEqual(1, tree2.find(5).size)

        tree2.insert(3)
        self.assertEqual(3, tree2.find(3).key)
        self.assertEqual(2, tree2.find(5).size)
        self.assertEqual(1, tree2.find(3).size)

        tree2.insert(4)
        self.assertEqual(4, tree2.find(4).key)
        self.assertEqual(3, tree2.find(5).size)
        self.assertEqual(2, tree2.find(3).size)
        self.assertEqual(1, tree2.find(4).size)

        tree2.insert(4)
        self.assertEqual(4, tree2.find(4).key)
        self.assertEqual(4, tree2.find(5).size)
        self.assertEqual(3, tree2.find(3).size)
        self.assertEqual(2, tree2.find(4).size)
    ...
    def testDeleteNodeWithTwoChildren(self):
        ...
        self.assertEqual(1, self.tree1.find(4).size)
        self.assertEqual(1, self.tree1.find(16).size)
        self.assertEqual(3, self.tree1.find(15).size)
        self.assertEqual(1, self.tree1.find(42).size)
    ...
    def testDeleteRoot(self):
        ...
        self.assertEqual(2, self.tree1.find(16).size)
        self.assertEqual(1, self.tree1.find(15).size)
        self.assertEqual(5, self.tree1.find(42).size)
